...
int main()
{
    ...
    Shader shader("shaders/lightVert.glsl", "shaders/MaterialPhong.glsl");
    ...
    glm::vec3 matAmbient = glm::vec3(0.25f);
    glm::vec3 matDiffuse = glm::vec3(0.4f);
    glm::vec3 matSpecular = glm::vec3(0.774597f);
    float shininess = 0.6 * 128.0f;
    ...
    /*    matAmbient.x = cos(glfwGetTime() * 1.0f);
        ...
        shader.setFloat("matieral.shininess", shininess);
