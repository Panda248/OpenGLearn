...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600, "Light Casters", NULL, NULL);
    ...
    Shader shader("shaders/lightingMapVert.glsl", "shaders/multipleLightFrag.glsl"); // Directional Light
    ...
    unsigned int specularMap = loadImage("resources/container2_specular.png");
    ...
    glm::vec3 spotLightAmbient = glm::vec3(0.2f);
    glm::vec3 spotLightDiffuse = glm::vec3(0.5f);
    ...
    shader.setVec3("directionLight.direction", glm::vec3(1.0f, -1.0f, -1.0f));
    shader.setVec3("directionLight.ambient", dirLightAmbient);
    shader.setVec3("directionLight.diffuse", dirLightDiffuse);
    shader.setVec3("directionLight.specular", dirLightSpecular);
    ...
    /*shader.setVec3("pointLights[1].position", lightPos);
    shader.setFloat("pointLights[1].constant", 1.0);
    shader.setFloat("pointLights[1].linear", 0.09);
    shader.setFloat("pointLights[1].quadratic", 0.032);
    shader.setVec3("pointLights[1].ambient", lightAmbient);
    shader.setVec3("pointLights[1].diffuse", lightDiffuse);
    shader.setVec3("pointLights[1].specular", lightSpecular);

    shader.setVec3("pointLights[2].position", lightPos);
    shader.setFloat("pointLights[2].constant", 1.0);
    shader.setFloat("pointLights[2].linear", 0.09);
    shader.setFloat("pointLights[2].quadratic", 0.032);
    shader.setVec3("pointLights[2].ambient", lightAmbient);
    shader.setVec3("pointLights[2].diffuse", lightDiffuse);
    shader.setVec3("pointLights[2].specular", lightSpecular);

    shader.setVec3("pointLights[3].position", lightPos);
    shader.setFloat("pointLights[3].constant", 1.0);
    shader.setFloat("pointLights[3].linear", 0.09);
    shader.setFloat("pointLights[3].quadratic", 0.032);
    shader.setVec3("pointLights[3].ambient", lightAmbient);
    shader.setVec3("pointLights[3].diffuse", lightDiffuse);
    shader.setVec3("pointLights[3].specular", lightSpecular);*/
    ...
    shader.setFloat("material.emmisiveness", 0.0f);
